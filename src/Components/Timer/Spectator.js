...
function Spectator({room}) {
  ...
  useEffect(() => {
    if (runner1?.['state'] === 'ready') setAlreadySolving(false);
  ...
  }, [runner1, setTimer1, setAlreadySolving]);
      ...
      <span className="spectator__runners">
        ...
        <span>
          ...
          <h1>
            ...
            (runner1?.['current-time'] === 0
              ?
            (runner1?.['state'] === 'solving' ? (alreadySolving ? 'SOLVING' : formatTimer(timer1)) : runner1?.['state'])
              :
            formatTimer(runner1?.['current-time']))}
          </h1>
        </span>
        ...
        <span>
          ...
          <h1>
            ...
            (runner2?.['current-time'] === 0
              ?
            (runner2?.['state'] === 'solving' ? (alreadySolving ? 'SOLVING' : formatTimer(timer2)) : runner2?.['state'])
              :
            formatTimer(runner2?.['current-time']))}
          </h1>
        </span>
